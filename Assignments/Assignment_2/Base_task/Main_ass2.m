...
%rosinit
cd('/home/vise/Universita/Autonomous_vehicles/Assignments/Assignment_2/Main')
...
% Select critical radius around waypoints, to change control law (stop and
% adjust the heading)
...
for ii=1:8:length(time)
    ...
    if ii==1 || ii==2985 || ii==6161 || ii==13969 || ii==19401 || ii==23201 || ii==25905 || ii==29601 || ii==32201 || ii==34641
