...
[niter,nnodes,path_length,elatime]=RRT(map,start,goal,max_iter,step,bias,false,false);
...
[niter,nnodes,path_length,elatime]=RRT_connect(map,start,goal,max_iter,step,bias,greedy,false);
path_length=300*path_length/n;
...
[niter,nnodes,path_length,elatime]=RRT_star_informed(map,start,goal,max_iter,step,bias,patience,informed,false);
path_length=300*path_length/n;
